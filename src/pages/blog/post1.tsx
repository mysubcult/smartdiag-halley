  ...
  return (
    <Layout title={metadata.title} description={metadata.description} keywords={metadata.keywords}>
      <main className="bg-white dark:bg-neutral-900 w-full px-4 pt-24 pb-16">
        <div className="container mx-auto flex flex-col sm:flex-row sm:justify-between sm:space-x-6">
          ...
          <div className={`sm:w-1/6 w-full text-center sm:text-left ${isMenuOpen ? 'block' : 'hidden'} sm:block sm:sticky top-24 h-max self-start bg-white dark:bg-neutral-900 text-neutral-900 dark:text-neutral-300 px-4 mx-auto shadow-lg rounded-lg border border-neutral-200 dark:border-neutral-700 py-4 transition-all duration-300 ease-in-out`}>
          ...
          <div className="sm:w-4/6 w-full sm:max-w-4xl mx-auto px-4 pt-6 sm:pt-0">
            {/* Заголовок статьи */}
          ...
          <div className="sm:w-1/6 hidden sm:block"></div>
        </div>
      </main>
    </Layout>
  );
