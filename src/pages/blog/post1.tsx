...
import Head from "next/head"; // Добавляем next/head для управления заголовками страницы

export default function BlogPost() {
  const [isSticky, setIsSticky] = useState(false);

  // Эффект для обработки залипания боковой панели
  useEffect(() => {
    const handleScroll = () => {
  ...
  return (
    <>
      <Head>
        {/* Убедитесь, что заголовок и мета-теги корректны */}
        ...
        />
        {/* Подключаем стили */}
        <link rel="stylesheet" href="/styles/globals.css" /> {/* Обратите внимание на кэширование */}
      </Head>
        ...
        <div className="bg-white dark:bg-neutral-900 w-full px-4 pt-32 pb-16">
          <div className="container mx-auto flex flex-col lg:flex-row">
            ...
            <div className="relative lg:flex lg:space-x-8">
              {/* Боковая панель */}
              <aside
                className={`lg:w-1/4 px-4 sticky top-32 h-auto ${
              ...
              >
                <div className="border border-neutral-300 dark:border-neutral-700 rounded-lg p-4 bg-white dark:bg-neutral-900 shadow-lg">
                  ...
                  <nav className="space-y-4">
                    <a
                      href="#antivirus-issue"
                      className="block text-neutral-900 dark:text-neutral-400 hover:text-red-500"
                    >
                      Проблема с антивирусом
                    </a>
                    <a
                      href="#outdated-software"
                      className="block text-neutral-900 dark:text-neutral-400 hover:text-red-500"
                    >
                      Устаревшее ПО
                    </a>
              ...
              <div className="w-full lg:w-3/4 mx-auto px-4 text-center">
                ...
                <p
                  id="introduction"
                  className="pt-6 pb-8 text-base max-w-2xl m-auto dark:text-neutral-400"
                >
                  В этой статье мы рассмотрим наиболее частые причины ошибок
                  при открытии архивов и предложим решения для их устранения...
                </p>
                ...
                <div className="max-w-3xl mx-auto text-lg leading-relaxed text-center">
                  <p className="mb-4" id="antivirus-issue">
                    <strong>Проблема с антивирусом:</strong> Часто проблемы с
                    открытием архивов вызваны антивирусным программным
                    обеспечением...
                  </p>

                  <p className="mb-4" id="outdated-software">
                    <strong>Устаревшее программное обеспечение:</strong> Если вы
                    используете старую версию программного обеспечения для
                    работы с архивами...
                  </p>

                  <p className="mb-4" id="download-errors">
                    <strong>Ошибки при загрузке:</strong> Иногда архив может не
                    открываться из-за ошибок при его загрузке...
                  </p>

                  <p className="mb-4" id="yandex-tips">
                    <strong>Советы для пользователей Яндекс Браузера:</strong> В
                    Яндекс Браузере может быть включена защита, блокирующая
                    некоторые файлы...
                  </p>

                  <p className="mb-4" id="support">
                    Если перечисленные выше шаги не помогают, обратитесь в
                    службу поддержки для получения дополнительной помощи...
                  </p>
                </div>
