...
const products = [
  ...
  },
  {
    ...
    href: "https://i.getspace.us/cloud/s/smqoBS5FHkfN4AR",
    cta: "Скачать",
    mostPopular: false,
  },
  {
...
export default function Soft() {
  ...
  return (
    <div className="bg-gray-50 dark:bg-neutral-900" id="soft">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-16 grid md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-x-6 gap-y-16">
        {products.map(
          ({
            title,
            mostPopular,
