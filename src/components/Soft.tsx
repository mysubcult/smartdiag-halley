    ...
    <div className="bg-gray-50 dark:bg-neutral-900" id="soft">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16">
        ...
        <p className="pt-6 text-base max-w-2xl text-center m-auto dark:text-neutral-400">
          В этом разделе нашего сайта мы собрали все необходимые программы в одном месте для максимального удобства наших пользователей. Чтобы загрузить необходимое ПО, вам просто нужно выбрать ваше оборудование из списка и нажать кнопку &quot;Скачать&quot;. Далее откроется окно, где вы сможете выбрать желаемую версию программы. Чтобы начать загрузку, просто нажмите на иконку с тремя точками рядом с версией и выберите &quot;Скачать&quot;.
        </p>
      </div>
