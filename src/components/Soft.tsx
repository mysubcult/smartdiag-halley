...
const products = [
  ...
  },
  {
    ...
    currency: "$",
    frecuency: "month",
    description: "Инструмент диагностики автомобилей для чтения и удаления кодов неисправностей, а также тестирования различных систем и компонентов автомобиля.",
    features: [
      "Delphi 2021.10b",
      "Autocom 2021.11",
      "Wurth WoW 5.00.8",
