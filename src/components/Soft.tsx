...
<div class="mx-auto px-4 sm:px-6 lg:px-8 sm:flex sm:flex-col sm:align-center">
  <div class="relative self-center text-base font-semibold mt-6 bg-neutral-200 dark:bg-neutral-800 rounded-lg flex sm:mt-8">
    <button
      onClick={() => setBillingInterval("month")}
      type="button"
      class="relative w-1/3 bg-white dark:bg-neutral-600 text-neutral-900 dark:text-neutral-100 rounded-md m-1 py-2 whitespace-nowrap sm:w-auto sm:px-8"
    >
      Мультимарочные
    </button>
    <button
