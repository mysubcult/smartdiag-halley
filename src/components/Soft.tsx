...
<Link
  href={href}
  target="_blank"
  className={`mt-4 mx-2 block px-6 py-3 font-medium leading-4 text-center rounded-lg ${
    mostPopular
...

{
  ...
  href={docsLink}
  target="_blank"
  className={`mt-4 mx-2 block px-6 py-3 font-small leading-4 text-center rounded-lg ${
    mostPopular
