...
export default function Soft() {
  ...
  return (
    <div className="bg-gray-50 dark:bg-neutral-900" id="soft">
      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 flex justify-center mt-6 sm:mt-8">
        <button
          ...
          className={`${
            billingInterval === "month"
              ...
              : "bg-neutral-200 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-400"
          } rounded-md m-1 py-2 px-6 whitespace-nowrap`}
        >
          Мультимарочные
        </button>
        <button
