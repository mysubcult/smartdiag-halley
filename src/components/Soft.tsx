...
<div className="mx-auto px-4 sm:px-6 lg:px-8 sm:flex-col sm:align-center">
  <div className="relative self-center text-base font-semibold mt-6 bg-neutral-200 dark:bg-neutral-800 rounded-lg flex flex-col sm:mt-8">
    <button
      ...
      className={`${
        billingInterval === "month"
          ...
          : "relative w-full sm:w-1/2 text-neutral-900 dark:text-neutral-400"
