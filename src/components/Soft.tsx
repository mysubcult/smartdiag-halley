    ...
    <div className="bg-gray-50 dark:bg-neutral-900" id="soft">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16">
        ...
        <p className="pt-6 text-base max-w-2xl text-center m-auto dark:text-neutral-400">
          Найдите и скачайте программное обеспечение для вашего прибора в этом разделе сайта. Для начала выберите тип вашего прибора: &quot;Мультимарочный&quot; или &quot;Марочный&quot;. Затем найдите карточку с вашим устройством и скачайте программное обеспечение, нажав кнопку &quot;Скачать&quot;. Если вам нужна помощь с установкой, нажмите кнопку &quot;Инструкция&quot;.
        </p>
      </div>
