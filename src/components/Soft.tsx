...
<div className="mx-auto px-4 sm:px-6 lg:px-8">
  <div className="relative self-center text-base font-semibold mt-6 bg-neutral-200 dark:bg-neutral-800 rounded-lg flex flex-col sm:flex-row sm:mt-8">
    <button
      onClick={() => setBillingInterval("month")}
      type="button"
      className={`${
        billingInterval === "month"
          ? "w-auto mx-auto bg-white dark:bg-neutral-600 text-neutral-900 dark:text-neutral-100"
          : "ml-0.5 w-auto mx-auto text-neutral-900 dark:text-neutral-400"
