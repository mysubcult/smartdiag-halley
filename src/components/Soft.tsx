...
<div class="mx-auto px-4 sm:px-6 lg:px-8">
  <div class="relative self-center text-base font-semibold mt-6 bg-neutral-200 dark:bg-neutral-800 rounded-lg flex sm:mt-8" id="billing-buttons">
    <button
      onClick="setBillingInterval('month')"
      type="button"
      class="relative w-1/2 bg-white dark:bg-neutral-600 text-neutral-900 dark:text-neutral-100 rounded-md m-1 py-2 whitespace-nowrap sm:w-auto sm:px-8"
    >
      Мультимарочные
    </button>
    <button
      ...
      type="button"
      class="relative w-1/2 bg-white dark:bg-neutral-600 text-neutral-900 dark:text-neutral-100 ml-0.5 rounded-md m-1 py-2 whitespace-nowrap sm:w-auto sm:px-8"
    >
      Марочные
    </button>
    <button
...
function checkWidth() {
  ...
  if (windowSize < 640) {
    $('#billing-buttons').addClass('flex-col');
  } else {
    $('#billing-buttons').removeClass('flex-col');
  }
}
