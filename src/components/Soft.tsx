    ...
    <div className="bg-gray-50 dark:bg-neutral-900" id="soft">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16">
        ...
        <p className="pt-6 text-base max-w-2xl text-center m-auto dark:text-neutral-400">
          В данном разделе сайта мы собрали все необходимые программы в одном месте для максимальной удобности пользователей. Выбрав нужное оборудование из списка, вы сможете с легкостью скачать и установить соответствующее ПО. Чтобы скачать нужное ПО, вам необходимо выбрать ваше оборудование из списка и нажать кнопку &quot;скачать&quot;. Далее появится новое окно, где вам нужно выбрать желаемую версию программного обеспечения. После этого вы можете скачать ПО, нажав на иконку с тремя точками рядом с версией и выбрав опцию &quot;скачать&quot;.
        </p>
      </div>
