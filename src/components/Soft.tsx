    ...
    <div className="bg-gray-50 dark:bg-neutral-900" id="soft">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16">
        ...
        <p className="pt-6 text-base max-w-2xl text-center m-auto dark:text-neutral-400">
          В данном разделе сайта собраны все необходимые программы для оборудования. Перед выбором прибора из списка, необходимо определиться с категорией оборудования, выбрав между &quot;мультимарочным&quot; или &quot;марочным&quot;. После выбора категории и нахождения нужного прибора в списке, можно перейти к загрузке ПО (инструкции по установке для каждой программы находятся внутри). Для этого необходимо нажать кнопку &quot;Скачать&quot; и выбрать желаемую версию программы в появившемся окне. Чтобы начать загрузку, нужно нажать на иконку с тремя точками рядом с необходимой версией и выбрать &quot;Скачать&quot;.
        </p>
      </div>
