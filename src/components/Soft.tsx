    ...
    <div className="bg-gray-50 dark:bg-neutral-900" id="soft">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16">
        ...
        <p className="pt-6 text-base max-w-2xl text-center m-auto dark:text-neutral-400">
          Скачайте программное обеспечение для вашего устройства в этом разделе. Для начала выберите тип вашего устройства - &quot;Марочный&quot; или &quot;Мультимарочный&quot; (информация о типе вашего прибора находится в упаковке с устройством). Затем найдите карточку с вашим устройством и нажмите кнопку &quot;Скачать&quot;. Инструкция по установке программного обеспечения находится на кнопке &quot;Инструкция&quot;.
        </p>
      </div>
