...
export default function Soft() {
 ...
 <div className="mx-auto px-4 sm:px-6 lg:px-8 flex-col items-center">
  <div className="relative self-center text-base font-semibold mt-6 bg-neutral-200  dark:bg-neutral-800 rounded-lg flex-col sm:flex sm:align-center">
    <button
      onClick={() => setBillingInterval("month")}
      type="button"
      className={`${
        billingInterval === "month"
          ? "relative w-full sm:w-1/2 bg-white dark:bg-neutral-600 text-neutral-900 dark:text-neutral-100"
          : "ml-0.5 relative w-full sm:w-1/2 text-neutral-900 dark:text-neutral-400"
