...
const Filters: React.FC<FiltersProps> = ({ selectedType, setSelectedType, searchQuery, setSearchQuery }) => (
...
const DownloadModal: React.FC<DownloadModalProps> = ({ links, onClose }) => (
  <AnimatePresence>
    <motion.div
...
export default function Soft() {
  ...
  return (
    <div className="bg-white dark:bg-black" id="soft">
      ...
      {modalLinks && <DownloadModal links={modalLinks} onClose={closeModal} />}
    </div>
  );
}
