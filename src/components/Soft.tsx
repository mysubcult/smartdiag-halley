...
const products = [
  {
    ...
    currency: "$",
    frecuency: "month",
    description: "Многофункциональный диагностический инструмент для автомобилей, который используется для обнаружения и устранения неисправностей в электронных системах автомобиля.",
    features: [
      "Delphi 2021.10b",
      "Autocom 2021.11",
      "Wurth WoW 5.00.8",
  ...
  },
  {
    ...
    currency: "$",
    frecuency: "month",
    description: "Универсальный диагностический сканер, который позволяет производить чтение и удаление кодов неисправностей, а также диагностировать и тестировать различные компоненты и системы автомобиля.",
    features: [
      "Delphi 2021.10b",
      "Autocom 2021.11",
      "Wurth WoW 5.00.8",
    ...
    currency: "$",
    frecuency: "month",
    description: "Мощный инструмент диагностики автомобилей, который позволяет осуществлять чтение и удаление кодов неисправностей, а также проводить диагностику и тестирование различных систем и компонентов автомобиля, таких как двигатель, трансмиссия, ABS, система кондиционирования и другие.",
    features: [
      "Delphi 2021.10b",
      "Autocom 2021.11",
      "Wurth WoW 5.00.8",
