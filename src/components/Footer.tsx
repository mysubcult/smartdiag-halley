...
const menus = [
  { title: "Главная", section: "hero" },
  { title: "Программы", section: "soft" },
  { title: "О нас", section: "services" },
  { title: "Блог", section: "blog" },
  { title: "Обратная связь", section: "contact" },
];
    ...
    <footer className="bg-white dark:bg-neutral-900 border-t border-neutral-200">
      <div className="mx-auto px-6 lg:px-8 py-24 lg:py-4 grid grid-cols-1 lg:grid-cols-3">
        ...
        <nav className="order-2 lg:order-2 py-10 lg:py-0 lg:flex gap-6 text-center mx-auto">
          {menus.map(({ title, section }) => (
            <Link key={title} href="/" scroll={false}>
              <div
                className="py-2 hover:text-red-500 font-medium"
        ...
        <div className="flex gap-8 max-w-full justify-center my-auto lg:justify-end order-1 lg:order-3">
          {/* Социальные ссылки */}
          <Link href="https://смартдиаг-поддержка.рф/telegram" target="_blank" rel="noopener noreferrer">
          ...
          <Link href="https://смартдиаг-поддержка.рф/whatsapp" target="_blank" rel="noopener noreferrer">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
