...
const faqitems = [
  ...
  },
  {
    ...
    response:
      "Мы готовы помочь всем нашим клиентам в следующее рабочее время: Понедельник - Пятница: с 10:00 до 19:00 по московскому времени. Суббота и Воскресенье: с 10:00 до 18:00 по московскому времени. Чтобы получить необходимую помощь, пожалуйста, свяжитесь с нами через онлайн-чат на сайте, мобильные мессенджеры или заполните форму обратной связи, чтобы оставить заявку на помощь в установке. Мы обязательно свяжемся с вами в кратчайшие сроки и поможем решить любые вопросы по нашему программному обеспечению. Не стесняйтесь обращаться к нам в указанные рабочие часы - мы всегда готовы помочь вам!",
  },
];
  ...
  return (
    ...
    >
      ...
      <p className="pt-6 pb-8 text-base max-w-2xl text-center m-auto dark:text-neutral-400">
        Здесь вы найдете информацию о наших товарах и услугах, оплате, доставке и других важных вопросах. Этот раздел создан для вашего удобства, чтобы вы могли быстро получить ответы и сэкономить время на общении с нашей поддержкой.
      </p>
