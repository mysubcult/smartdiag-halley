  ...
  return (
    ...
    >
      ...
      <p className="pt-6 pb-8 text-base max-w-2xl text-center m-auto dark:text-neutral-400">
        Здесь вы найдете информацию о наших товарах и услугах и других важных вопросах. Этот раздел создан для вашего удобства, чтобы вы могли быстро получить ответы и сэкономить время на общении с нашей поддержкой.
      </p>
