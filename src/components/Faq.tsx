...
const faqitems = [
  ...
  },
  {
    ...
    response:
      "Мы готовы помочь вам в следующие часы:
Пн-Пт: 10:00-19:00 (по московскому времени)
Сб-Вс: 10:00-18:00 (по московскому времени)
Свяжитесь с нами через онлайн-чат на сайте, мессенджеры или заполните форму обратной связи для помощи в установке. Мы ответим быстро и решим ваши вопросы по программному обеспечению. Обращайтесь в указанные часы - мы здесь, чтобы помочь!",
  },
];
