...
const products = [
  {
    ...
    currency: "$",
    frecuency: "month",
    description: "Универсальный прибор для диагностики автомобилей, который позволяет проводить обширный диагностический анализ, включая чтение и очистку кодов ошибок, проверку параметров и компонентов системы, а также программирование и калибровку ключей и модулей управления.",
    features: [
      "Delphi 2021.10b",
      "Autocom 2021.11",
      "Wurth WoW 5.00.8",
