...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {isMenuOpen && (
        <div
          className="fixed top-16 left-0 right-0 bottom-0 bg-white dark:bg-neutral-900 flex flex-col items-center justify-center transition-opacity duration-300 ease-in-out z-60 overflow-y-auto"
        >
