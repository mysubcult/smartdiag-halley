...
export function Hero() {
  ...
  <a className="bg-black text-white rounded-full py-3 px-6 text-base font-medium flex items-center group shadow-lg transform transition-transform duration-300 hover:scale-105 hover:bg-gray-800 hover:bg-opacity-90">
    Обратная связь
  </a>
</Link>
          </div>
