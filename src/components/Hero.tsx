...
export const Hero: FC = () => {
  return (
    <section
      id="hero"
      className="min-h-screen w-full flex items-center justify-center pt-24 pb-16 lg:pt-32 lg:pb-24 bg-gradient-to-r from-blue-500 to-purple-500"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center justify-center gap-8 w-full">
        <div className="flex flex-col justify-center text-center lg:text-left space-y-6 lg:w-1/2 w-full">
          <motion.h1
            className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight text-white max-w-xl mx-auto lg:mx-0"
          ...
          <motion.p
            className="text-lg sm:text-xl text-gray-200 mx-auto lg:mx-0"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
