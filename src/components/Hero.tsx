...
export function Hero() {
        ...
        <div className="flex flex-col justify-center text-center sm:text-start space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4">
            <Link href="#soft" scroll={false}>
              <a className="inline-flex bg-gradient-to-r from-[#ff4b2b] to-[#ff416c] text-white rounded-full py-3 px-6 text-base font-medium flex items-center group shadow-lg transform transition-transform duration-300 hover:scale-105 hover:bg-opacity-90">
  ...
  <a className="inline-flex bg-black text-white rounded-full py-3 px-6 text-base font-medium flex items-center group shadow-lg transform transition-transform duration-300 hover:scale-105 hover:bg-gray-800 hover:bg-opacity-90">
    Обратная связь
  </a>
</Link>
          </div>
