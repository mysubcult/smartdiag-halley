                ...
                <button className="btn-grad-red text-base font-medium flex items-center">
                  ...
                  <span className="icon-container ml-2">
                    <svg className="icon w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 22.5c-5.859 0-10.5-4.641-10.5-10.5S6.141 1.5 12 1.5 22.5 6.141 22.5 12 17.859 22.5 12 22.5zm-.75-16.5h-1.5v5.25h1.5V6zm0 7.5h-1.5v-1.5h1.5v1.5z" fill="currentColor"/>
                    </svg>
                  </span>
                </button>
              </Link>
