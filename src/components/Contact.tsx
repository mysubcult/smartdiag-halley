...
<div className="flex items-center mt-2 space-x-2 text-dark-600 dark:text-neutral-400">
  ...
  <a href="https://t.me/smartdiag_robot" target="_blank">
    <div className="flex items-center mt-2 space-y-2 text-dark-600 dark:text-neutral-400"><img src="https://api.qrserver.com/v1/create-qr-code/?data=https://t.me/smartdiag_robot&amp;size=70x70&amp;color=007BFF" alt="QR Code" /></div>
  </a>
</div>
