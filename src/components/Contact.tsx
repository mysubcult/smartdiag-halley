        ...
        <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg shadow-lg">
          ...
          <div className="mb-6">
            ...
            <div className="flex justify-center space-x-8">
              <ContactInfo
                href="https://t.me/your_telegram_username" // Замените на вашу реальную ссылку Telegram
                ...
                icon={
                  <svg
                    ...
                    fill="currentColor"
                  >
                    <path d="M120,0C53.73,0,0,53.73,0,120c0,66.271,53.73,120,120,120s120-53.729,120-120C240,53.73,186.271,0,120,0ZM166.7,88.1L119.2,163.1c-0.7,1.7-2.4,2.5-4.1,2.2l-27.7-7.3c-1.8-0.5-3.4-2.1-4-4l-16.8-48.4c-0.4-1.4,0.4-2.9,1.5-3.5l81.8-33.2c1.2-0.5,2.7,0,3.1,1.2l23.2,72.4c0.3,1-0.2,2-1.1,2.4l-60,21.4c-0.9,0.3-1.8-0.2-2.1-1.1L85.3,106c-0.3-0.9,0.2-1.8,1.1-2.1l49.2-14.2c0.9-0.3,1.9,0.2,2.2,1.1L166.7,88.1Z"/>
                  </svg>
                }
                hoverColor="hover:text-blue-500"
              />
              <ContactInfo
                href="https://wa.me/your_whatsapp_number" // Замените на вашу реальную ссылку WhatsApp
...
const ErrorMessage: React.FC<MessageProps> = ({ onReset }) => (
  <div className="flex flex-col items-center justify-center text-center text-gray-700 dark:text-gray-300 rounded-md">
    <svg
      width="97"
      height="97"
      viewBox="0 0 97 97"
