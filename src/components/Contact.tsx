...
export default function Contact() {
  ...
  const htmlLinkToTerms = (`Я прочитал и согласен с <a href="#!" onclick="showPopup()" class="terms-link">правилами на обработку персональных данных</a>.`);
    ...
    <div className="bg-white-50 dark:bg-neutral-900" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 text-center">
        ...
        <p className="pt-6 pb-6 text-base max-w-2xl text-center m-auto dark:text-neutral-400">
          Наша команда прилагает все усилия для оперативного реагирования на Ваши запросы в самые кратчайшие сроки. Мы гарантируем, что ответ на Вашу заявку будет предоставлен в течение 12 рабочих часов. Если у Вас возникли срочные вопросы, пожалуйста, обращайтесь к нам через онлайн-чат на нашем сайте или свяжитесь с нами через доступные мессенджеры.
        </p>
      </div>
...
<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 grid md:grid-cols-2 lg:grid-cols-2 gap-y-8 md:gap-x-8 md:gap-y-8 lg:gap-x-8 lg:gap-y-16">
        <div>
          ...
          <p className="max-w-sm mt-4 mb-4 dark:text-neutral-400">
            Оставайтесь на связи с нами в любом месте. Получайте оперативную помощь и ответы на вопросы от нашей поддержки через мессенджеры. Мы доступны в Telegram и WhatsApp:
          </p>
...
<div className="flex items-center mt-2 space-x-2 text-dark-600 dark:text-neutral-400">
  ...
  <div>
    <a href="https://wa.me/message/XVMV4LKBTXB4E1" target="_blank">
      <img src="/images/hero/whatsapp-qr.svg"  className="transition-transform duration-300 ease-in-out transform hover:scale-110" width="120" height="120" alt="QR Code" />
    </a>
  </div>
</div>
        </div>
...
<div className="mb-3 relative">
  ...
  watch("topic") === "Активация прибора" 
    ...
    : watch("topic") === "Помощь с установкой ПО"
      ? "Уточните модель прибора и удобное для вас время, когда мы можем связаться с вами для дистанционной установки ПО."
    : watch("topic") === "Заказ оборудования"
      ? "Мы рады предложить вам разнообразный ассортимент приборов, доступных как с наших складов в Москве, так и напрямую от китайских поставщиков. У нас есть всё, что вам может понадобиться, и это по лучшим ценам. Напишите нам, чтобы уточнить подробности."                
