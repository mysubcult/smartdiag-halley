...
export default function Contact() {
  ...
  return (
    <div className="bg-white dark:bg-neutral-900" id="contact">
      ...
      <motion.div
        className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 grid md:grid-cols-2 gap-y-8 md:gap-x-8"
        initial="hidden"
        animate="visible"
        variants={{
...
const SuccessMessage: React.FC<MessageProps> = ({ onReset }) => (
  <motion.div
    className="flex flex-col items-center justify-center text-center text-white rounded-md"
    initial={{ opacity: 0, y: 20 }}
    animate={{ opacity: 1, y: 0 }}
...
const ErrorMessage: React.FC<MessageProps> = ({ onReset }) => (
  <motion.div
    className="flex flex-col items-center justify-center text-center text-neutral-900 dark:text-neutral-300 rounded-md"
    initial={{ opacity: 0, y: 20 }}
    animate={{ opacity: 1, y: 0 }}
    transition={{ duration: 0.5 }}
  >
