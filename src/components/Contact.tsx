...
const ContactInfo = ({ href, imageSrc, alt, platform, iconColor }: { href: string; imageSrc: string; alt: string; platform: string; iconColor: string }) => (
  <div className="flex flex-col items-center space-y-2 mx-4">
    <div className="flex items-center space-x-2">
      ...
      <a
        href={href}
        target="_blank"
        className={`hover:text-${iconColor}-500`}
        style={{ width: '90px' }}
      >
        {platform}
      </a>
