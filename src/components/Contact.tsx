      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 grid md:grid-cols-2 lg:grid-cols-2 gap-y-8 md:gap-x-8 md:gap-y-8 lg:gap-x-8 lg:gap-y-16">
        <div>
          ...
          <p className="max-w mt-4 mb-4 dark:text-neutral-400 text-center">
            🏢 <strong>Адрес:</strong>
            <br />
            <span className="block mt-2">г. Тольятти, Ленинградская 68</span>
            📞 <strong>Телефон:</strong>
            <br />
            <span className="block mt-2">+7 (123) 456-78-90</span>
            📧 <strong>Email:</strong>
            <br />
            <span className="block mt-2">info@example.com</span>
          </p>

          <div className="flex justify-center mt-2 text-dark-600 dark:text-neutral-400">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2389.2672578350473!2d49.3463675!3d53.5098036!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4165a203737829e3%3A0x7d0b01c59eb88588!2z0YPQuy4g0JLQuNC70L7QstGB0LrQuNC5INCc0L7RgdC60LDRjywgNjgsINCi0LDRgNCw0L3QuNGPINC60YDQuNGB0LrQsNGPINGD0LsuLCA0NDQzNjA!5e0!3m2!1sru!2sru!4v1626953754035!5m2!1sru!2sru"
              width="300"
              height="225"
              style={{ border: "0" }}
              allowFullScreen
              ...
              <div className="mb-3 relative">
                ...
                <div className="relative">
                  <select
                    id="topic"
                    autoComplete="off"
                    className={`select-dropdown w-full px-4 py-3 appearance-none ${
                      errors.topic
                  ...
                  >
                    ...
                    <option value="Сообщить о проблеме">
                      Сообщить о проблеме
                    </option>
