...
const ContactInfo = ({ href, imageSrc, alt, platform, iconPath, hoverColor }: { href: string; imageSrc: string; alt: string; platform: string; iconPath: string; hoverColor: string }) => (
  <div className="flex flex-col items-center space-y-2 mx-4">
    <div className="flex items-center space-x-2">
      <Image src={iconPath} alt={`${platform} icon`} width={24} height={24} />
      <a
        href={href}
        target="_blank"
