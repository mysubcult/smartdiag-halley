    ...
    <div className="bg-white-50 dark:bg-neutral-900" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 text-center">
        ...
        <p className="pt-6 pb-6 text-base max-w-2xl text-center m-auto dark:text-neutral-400">
          Наша команда оперативно отвечает на запросы, обеспечивая ответ в течение 12 рабочих часов. Если у Вас есть срочный вопрос, обращайтесь к нам через онлайн-чат или мессенджеры.
        </p>
      </div>

<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 grid md:grid-cols-2 lg:grid-cols-2 gap-y-8 md:gap-x-8 md:gap-y-8 lg:gap-x-8 lg:gap-y-16">
        <div>
          <h2 className="text-lg font-bold justify-center">💬 Мы в мессенджерах!</h2>
          <p className="max-w-sm mt-4 mb-4 dark:text-neutral-400">
            Оставайтесь на связи с нами в любом месте и получайте оперативную помощь и ответы на вопросы от нашей поддержки. Мы доступны в Telegram и WhatsApp:
          </p>
...
<div className="flex justify-center mt-2 text-dark-600 dark:text-neutral-400">
  <div className="flex flex-col items-center space-y-2 mx-4">
    <div className="flex items-center space-x-2">
      ...
      <a href="https://смартдиаг-поддержка.рф/telegram" target="_blank" className="hover:text-blue-500" style={{ width: "90px" }}>Telegram</a>
    </div>
    <div>
      <a href="https://смартдиаг-поддержка.рф/telegram" target="_blank">
  ...
  <div className="flex flex-col items-center space-y-2 mx-4">
    <div className="flex items-center space-x-2">
      ...
      <a href="https://смартдиаг-поддержка.рф/whatsapp" target="_blank" className="hover:text-green-500" style={{ width: "90px" }}>WhatsApp</a>
    </div>
    <div>
      <a href="https://смартдиаг-поддержка.рф/whatsapp" target="_blank">
        ...
        <div>
          <h2 className="text-lg font-bold justify-center">Обратная связь</h2>
          {!isSubmitSuccessful && (
