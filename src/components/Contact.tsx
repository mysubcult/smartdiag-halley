    ...
    <div className="bg-white-50 dark:bg-neutral-900" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 text-center">
        ...
        <p className="pt-6 pb-6 text-base max-w-2xl text-center m-auto dark:text-neutral-400">
          Мы ценим ваше мнение и стремимся улучшать наш сервис. Если у вас есть предложения, вопросы или замечания, пожалуйста, свяжитесь с нами. Вы можете связаться с нами через форму обратной связи ниже или через мессенджеры. Наша команда оперативно отвечает на запросы, обеспечивая ответ в течение 12 рабочих часов.
        </p>
      </div>
