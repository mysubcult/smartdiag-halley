        ...
        <div>
          ...
          <div className="flex justify-center mt-2 text-dark-600 dark:text-neutral-400">
            <div className="flex flex-col items-center space-y-2 mx-4">
              ...
              <div>
                <a href="https://смартдиаг-поддержка.рф/telegram" target="_blank" rel="noopener noreferrer">
                  <img
            ...
            <div className="flex flex-col items-center space-y-2 mx-4">
              ...
              <div>
                <a href="https://смартдиаг-поддержка.рф/whatsapp" target="_blank" rel="noopener noreferrer">
                  <img
                ...
                <div className="mb-3 relative">
                  ...
                  <input
                    ...
                    {...register('orderNumber', {
                      required: isActivationOrInstallation && 'Номер заказа обязателен',
                    })}
                  />
                  {errors.orderNumber && (
                    <div className="mt-1 text-rose-500">
