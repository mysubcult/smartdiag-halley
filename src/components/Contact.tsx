...
<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 grid md:grid-cols-2 lg:grid-cols-2 gap-y-8 md:gap-x-8 md:gap-y-8 lg:gap-x-8 lg:gap-y-16">
        <div>
          ...
          <p className="max-w mt-4 mb-4 dark:text-neutral-400 text-center">
            📲 Оставайтесь на связи с нами в любом месте и получайте оперативную помощь и ответы на вопросы от нашей поддержки.</br>
            🕑 Операторы тех.поддержки доступны онлайн с 10:00 до 19:00 по МСК с понедельника по пятницу и с 10:00 до 18:00 в выходные.</br>
