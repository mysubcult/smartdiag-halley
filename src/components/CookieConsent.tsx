...
const CookieConsent = () => {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-4 left-4 bg-white dark:bg-gray-800 shadow-lg p-4 rounded-lg w-72 border-2 border-gray-300 dark:border-gray-700 flex flex-col items-center space-y-3">
