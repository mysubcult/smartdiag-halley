...
const CookieConsent = () => {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-4 left-4 bg-white dark:bg-gray-800 shadow-lg p-4 rounded-lg w-80 border border-gray-200 dark:border-gray-700 flex flex-col items-center space-y-3">
        <p className="text-gray-800 dark:text-gray-200 text-sm w-full text-justify tracking-tight leading-relaxed">
